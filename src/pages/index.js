  ...
  return (
      <main>
          ...
          <div className="previous-work">
            ...
            <ul className="list">
              <li className="list-item">
                ...
                <h4 className="h4">
                  <a href="https://www.figma.com/community/file/942856928187155104">Building Open Source Plugins</a>
                </h4>
              </li>
              <li className="list-item">
                <h6 className="h6 timeline">
                ...
                <h4 className="h4">
                  <a href="https://blog.discord.com/building-open-source-design-tools-to-improve-discords-design-workflow-9a25c29f9143">Intro to Figma Plugin Api</a>
                </h4>
              </li>
              <li className="list-item">
                <h6 className="h6 timeline">
        ...
        <motion.section className="container next-project">
          <div className="grid">
            <h2 className="h2 grid-title">Case Studies Coming Soon</h2>
          </div>
